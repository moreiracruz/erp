package com.erp.modules.customer.adapter.in.web;
...
public class CustomerController {
    ...
    public ResponseEntity<ClienteResponse> update(@PathVariable UUID uuid,
        ...
        var updated = com.erp.modules.customer.domain.model.Cliente.create(
                cmd.fullName(),
                cmd.cpf(),
                cmd.email(),
                cmd.phone(),
        ...
        var restored = com.erp.modules.customer.domain.model.Cliente.restore(
                uuid,
                cmd.fullName(),
                cmd.cpf(),
                cmd.email(),
    ...
    public ResponseEntity<Page<ClienteResponse>> search(
        ...
        return ResponseEntity.ok(searchCustomerUseCase.search(query));
    }

    private ClienteResponse toResponse(com.erp.modules.customer.domain.model.Cliente c) {
