...
import com.erp.modules.sales.domain.port.in.CancelSaleCommand;
import com.erp.modules.sales.domain.port.in.CancelSaleUseCase;
...
public class SalesController {
    ...
    private VendaResponse toResponse(com.erp.modules.sales.domain.model.Venda venda) {
        var items = venda.getItems().stream()
                .map(item -> new com.erp.modules.sales.domain.port.in.ItemVendaResponse(
