package com.erp.modules.pricing.adapter.in.web;

import com.erp.modules.pricing.domain.model.Campanha;
import com.erp.modules.pricing.domain.port.in.CalculateDiscountUseCase;
import com.erp.modules.pricing.domain.port.in.CampanhaResponse;
import com.erp.modules.pricing.domain.port.in.ConfirmCouponUsageUseCase;
import com.erp.modules.pricing.domain.port.in.CreateCampaignCommand;
import com.erp.modules.pricing.domain.port.in.CreateCampaignUseCase;
...
import com.erp.modules.pricing.domain.port.in.DiscountQuery;
import com.erp.modules.pricing.domain.port.in.DiscountResult;
...
public class PricingController {
    ...
    public ResponseEntity<Void> deactivateCampaign(@PathVariable UUID uuid) {
        Campanha campanha = campanhaRepository.findByUuid(uuid)
                .orElseThrow(() -> new com.erp.shared.exceptions.NotFoundException(
