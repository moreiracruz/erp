package br.com.moreiracruz.erp.events;
...
class EventIdempotencyIT extends AbstractIntegrationTest {
    ...
    void duplicateEvents_createExactlyOneFinanceEntry() {
        ...
        jdbcTemplate.update("INSERT INTO variantes (uuid, produto_id, produto_uuid, sku, size, color, barcode, price, cost, active) VALUES (?, ?, ?, 'SKU-EVT1', 'M', 'X', '9990000000001', 10.00, 5.00, true)",
                varianteUuid, produtoId, produtoUuid);
    ...
    void duplicateEvents_commitStockExactlyOnce() {
        ...
        Long produtoId = jdbcTemplate.queryForObject(
                ...
                Long.class, produtoUuid);
        jdbcTemplate.update("INSERT INTO variantes (uuid, produto_id, produto_uuid, sku, size, color, barcode, price, cost, active) VALUES (?, ?, ?, 'SKU-EVT2', 'M', 'X', '9990000000002', 10.00, 5.00, true)",
                varianteUuid, produtoId, produtoUuid);
